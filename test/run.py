# The Registry implementation is also open-sourced by the authors, and available
# at https://github.com/modelscope/modelscope/blob/master/tests/run.py
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--test_dir', default='test', help='directory to be tested')
    parser.add_argument(
